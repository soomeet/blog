...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/soomeet/blog/blog/comment
   */
  queryCommentAll = (
    query?: {
    ...
    this.request<BlogQueryAllCommentResponse, RpcStatus>({
      path: `/soomeet/blog/blog/comment`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/soomeet/blog/blog/comments/{id}
   */
  queryComments = (
    id: string,
    query?: {
    ...
    this.request<BlogQueryCommentsResponse, RpcStatus>({
      path: `/soomeet/blog/blog/comments/${id}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/soomeet/blog/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/soomeet/blog/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/soomeet/blog/blog/posts
   */
  queryPosts = (
    query?: {
      "pagination.key"?: string;
